# Voynich Botanical-Crib Thesis: Formal Evaluation Report

**Author**: Tammy Lou Casey  
**Affiliation**: Independent Researcher  
**Date**: September 2026  

**Executive Summary**: The botanical-crib thesis is not viable as stated, and it fails for four independent reasons, any one of which is sufficient. It has been tried repeatedly since the 1940s and every attempt encountered the same fundamental breakdown. The single most damaging fact is structural, not statistical: the folios whose plants can be identified mostly have no discrete titles or labels at all.

Verification tags: **[V]** = read in primary source; **[R]** = secondary/reported; **[U]** = unverified.
