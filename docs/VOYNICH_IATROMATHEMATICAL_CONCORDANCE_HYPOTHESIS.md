...
- **Total Vocabulary Analyzed**: 8485 unique word types across 225 folios.
- **Triad Bridge Tokens (Zodiac + Herbal + Pharma)**: **310 distinct tokens** simultaneously bridge the astronomical, botanical, and pharmaceutical sections.
- **Celestial Star Labels as Triad Anchors**: **77 star labels** are embedded across all three domains.
...
|:---:|:---:|:---:|:---:|:---:|:---:|:---|
| `daiin` | **3 stars** (Cancer, Gemini, Leo) | 109 folios | 29 folios | 21 folios | 805 | Tripartite Anchor |
| `aiin` | **3 stars** (Cancer, Gemini) | 44 folios | 18 folios | 23 folios | 456 | Tripartite Anchor |
| `or` | **3 stars** (Gemini, Pisces) | 52 folios | 20 folios | 21 folios | 349 | Tripartite Anchor |
| `ar` | **4 stars** (Aries, Libra, Taurus) | 36 folios | 8 folios | 23 folios | 344 | Tripartite Anchor |
| `dar` | **2 stars** (Aries, Pisces) | 60 folios | 18 folios | 17 folios | 297 | Tripartite Anchor |
| `al` | **1 stars** (Gemini) | 16 folios | 9 folios | 22 folios | 253 | Tripartite Anchor |
| `dy` | **2 stars** (Pisces, Taurus) | 60 folios | 15 folios | 9 folios | 226 | Tripartite Anchor |
| `okaiin` | **2 stars** (Gemini, Leo) | 34 folios | 11 folios | 21 folios | 209 | Tripartite Anchor |
| `okeey` | **3 stars** (Taurus, Virgo) | 12 folios | 9 folios | 21 folios | 174 | Tripartite Anchor |
| `otedy` | **1 stars** (Scorpio) | 10 folios | 2 folios | 18 folios | 154 | Tripartite Anchor |
| `otaiin` | **2 stars** (Aries, Taurus) | 28 folios | 4 folios | 16 folios | 150 | Tripartite Anchor |
| `chdy` | **2 stars** (Aries, Libra) | 20 folios | 7 folios | 17 folios | 143 | Tripartite Anchor |
| `otar` | **2 stars** (Aries, Pisces) | 14 folios | 6 folios | 21 folios | 139 | Tripartite Anchor |
| `otal` | **6 stars** (Aries, Libra, Pisces, Taurus) | 16 folios | 6 folios | 19 folios | 137 | Tripartite Anchor |
| `oteey` | **2 stars** (Cancer, Gemini) | 6 folios | 9 folios | 18 folios | 135 | Tripartite Anchor |

---

## 3. Deep-Dive Case Studies of Canonical Concordance Anchors

### Anchor Token: `otal` (Corpus Occurrences: 137)

- **Celestial Node (Zodiac Stars Held by Nymphs)**:
  - **Pisces (Dark)** (Folio `70v2`)
  - **Pisces (Dark)** (Folio `70v2`)
  - **Pisces (Dark)** (Folio `70v2`)
  - **Aries (Dark)** (Folio `71r`)
  - **Taurus (Light)** (Folio `72r2`)
  - **Libra** (Folio `73r`)
- **Botanical Nodes (Herbal Folios)**: `3r`, `13v`, `24r`, `26r`, `27r`, `33r`, `39r`, `39v`, `41r`, `44v`, `48r`, `50r` ...
- **Apothecary Nodes (Pharma Folios)**: `89v2`, `89v1`, `95v1`, `99v`, `100r`, `101v`
- **Preparation Nodes (Recipe Stars)**: `103r`, `103v`, `104r`, `105v`, `106r`, `106v`, `107r`, `107v` ...

### Anchor Token: `okaly` (Corpus Occurrences: 22)
...
- **Celestial Node (Zodiac Stars Held by Nymphs)**:
  ...
  - **Scorpio** (Folio `73v`)
  - **Scorpio** (Folio `73v`)
- **Botanical Nodes (Herbal Folios)**: `4v`, `31v`, `41v`, `43v`, `48r`, `50r`, `57r`, `58v`, `65v`, `66r`
- **Apothecary Nodes (Pharma Folios)**: `99v`, `102r1`, `102r2`, `102v2`, `102v1`
- **Preparation Nodes (Recipe Stars)**: `104r`, `108v`, `112r`, `113r`

### Anchor Token: `am` (Corpus Occurrences: 87)

- **Celestial Node (Zodiac Stars Held by Nymphs)**:
  - **Pisces (Dark)** (Folio `70v2`)
  - **Pisces (Dark)** (Folio `70v2`)
  - **Aries (Light)** (Folio `71v`)
  - **Gemini** (Folio `72r3`)
- **Botanical Nodes (Herbal Folios)**: `1v`, `3r`, `4v`, `10r`, `24r`, `28v`, `40v`, `41r`, `48v`, `52r`, `54v`, `55v` ...
- **Apothecary Nodes (Pharma Folios)**: `87v`, `88r`, `89v2`, `89v1`, `94r`, `94v`, `95v1`, `99r` ...
- **Preparation Nodes (Recipe Stars)**: `103r`, `104v`, `105r`, `105v`, `106v`, `107r`, `108v`, `111r` ...

### Anchor Token: `ar` (Corpus Occurrences: 344)

- **Celestial Node (Zodiac Stars Held by Nymphs)**:
  - **Aries (Light)** (Folio `71v`)
  - **Aries (Light)** (Folio `71v`)
  - **Taurus (Dark)** (Folio `72r1`)
  - **Libra** (Folio `73r`)
- **Botanical Nodes (Herbal Folios)**: `1r`, `4v`, `8v`, `18v`, `20v`, `23r`, `23v`, `26v`, `31r`, `31v`, `33r`, `33v` ...
- **Apothecary Nodes (Pharma Folios)**: `88r`, `90r2`, `94v`, `95v2`, `95v1`, `96v`, `100v`, `102v2`
- **Preparation Nodes (Recipe Stars)**: `103r`, `103v`, `104r`, `104v`, `105r`, `105v`, `106r`, `106v` ...

### Anchor Token: `oky` (Corpus Occurrences: 88)
...
- **Celestial Node (Zodiac Stars Held by Nymphs)**:
  ...
  - **Libra** (Folio `73r`)
  - **Scorpio** (Folio `73v`)
- **Botanical Nodes (Herbal Folios)**: `1r`, `3r`, `9v`, `10r`, `14v`, `19v`, `21r`, `21v`, `22r`, `22v`, `24r`, `29r` ...
- **Apothecary Nodes (Pharma Folios)**: `87v`, `88r`, `89r2`, `93v`, `94r`, `94v`, `95r1`, `99r` ...
- **Preparation Nodes (Recipe Stars)**: `103r`, `103v`, `104r`, `105r`, `106r`, `106v`, `107v`, `113v` ...
